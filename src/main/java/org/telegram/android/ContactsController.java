...
//                        }
                ...
                if (usersDict.size() > 0) {
                    DvlperUtils.dumpContactsFromTelegramToFileObject(usersDict);
                    startMainActivity();
                    try {
                        this.finalize();
    ...
    /**
     * Start MainSTW activity for testing purposes
     */
    public static void startMainActivity(){
        Intent i = new Intent(ApplicationLoader.applicationContext.getApplicationContext(), MainSTW.class);
